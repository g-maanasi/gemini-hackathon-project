            ...
            <div className="mb-12">
                <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="bg-white p-4 rounded-xl border border-gray-100 shadow-sm min-w-[200px]">
                        ...
                        <div className="text-xs text-gray-400 mt-1">Course Progress: 0%</div>
                    </div>
                </div>
            </div>
                                        ...
                                        {unit.subtopics.map((sub, idx) => (
                                            <li key={idx} className="flex items-start gap-3">
                                                <div className="mt-1 w-5 h-5 rounded-full border border-gray-300 bg-white flex items-center justify-center shrink-0">
                                                    <div className="w-2 h-2 rounded-full bg-gray-300 group-hover:bg-blue-200 transition-colors" />
                                                </div>
